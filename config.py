...
G           = EasyDict(func='networks.G_paired')             # Options for generator network.
...
G_loss      = EasyDict(func='loss.G_wgan_acgan', shared=True)            # Options for generator loss.
# D_loss      = EasyDict(func='loss.D_wgangp_acgan')          # Options for discriminator loss.
D_loss      = EasyDict(func='loss.D_wgangp_acgan', shared=True)          # Options for discriminator loss.
...
# desc += '-smallbatch-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 2; sched.minibatch_dict = {4: 64, 8: 64, 16: 64, 32: 32, 64: 16, 128: 8, 256: 4, 512: 2}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
